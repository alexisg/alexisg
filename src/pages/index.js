...
const IndexPage = () => (
  <Layout>
    ...
    <section className="transition transition--fadein">
      <p>I am a Sr. Design Director at <a href="https://twitch.tv">Twitch.tv</a>. I lead the Consumer Product Design org responsible for our react-first Design System, and product experience across our viewer and creator apps. I believe in inclusive design driven by collaborative and empowering systems. Previously I was the Creative Technical Director at CBSi Games, where I led the redesigns of <a href="portfolio/gamespot/">GameSpot</a> and <a href="portfolio/giant-bomb/">Giant Bomb</a>.</p>
      ...
      <div className="js-media-hold nav-portfolio__media shadow aspect mg-b-2" data-video="/static/media/twitch-uv.mp4" data-img="/static/media/twitch-uv.jpg" data-title="Twitch" data-id="Twitch">
        <label for="Twitch" className="hide">Video of Twitch</label>
      
        <video id="Twitch" playsinline="" muted="" autoplay="" loop="" className="aspect__fill">
         <source src={"//www.alexisgallisa.com/static/media/twitch-uv.mp4"} type={"video/mp4"} />
        </video>
      </div>
